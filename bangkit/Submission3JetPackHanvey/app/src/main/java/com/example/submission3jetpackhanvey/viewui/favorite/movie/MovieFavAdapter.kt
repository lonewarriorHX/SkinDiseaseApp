...
class MovieFavAdapter : PagedListAdapter<MovieDataEnt, MovieFavAdapter.MovieViewHolder>(
    DIFF_CALLBACK
) {
    ...
    fun getSwipedData(swipedPosition: Int): MovieDataEnt? = getItem(swipedPosition)
